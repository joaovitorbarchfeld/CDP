...
SRCS1 := num_primos_paralelo_normal.cpp
OBJS1 := $(SRCS1:.cpp=.o)
EXECUTABLE1 := num_primos_paralelo_normal

# Source files and object files for Program 2
SRCS2 := num_primos_fila_concorrente_normal.cpp
OBJS2 := $(SRCS2:.cpp=.o)
EXECUTABLE2 := num_primos_fila_concorrente_normal
